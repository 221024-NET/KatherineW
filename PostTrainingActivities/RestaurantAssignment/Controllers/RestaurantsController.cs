...
namespace RestaurantAssignment.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        public RestaurantsController(RAContext context)
        {
            _context = context;
        }
        ...
        {
            var restaurant = await _context.Restaurants.FromSql<Restaurant>($"EXEC GetGoodRestaurants @Score = {score}").ToListAsync();
